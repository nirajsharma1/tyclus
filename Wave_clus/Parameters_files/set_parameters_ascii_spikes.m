...
par.min_clus = 50;                   % minimun size of a cluster
...
par.sr= 250;                         % sampling rate     
par.w_pre = 25;                          % number of pre-event data points stored 
par.w_post = 50;                         % number of post-event data points stored 
