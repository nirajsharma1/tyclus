...
handles.par.w_pre=25;                       %number of pre-event data points stored (default 20) - ** edit this **
handles.par.w_post=50;                      %number of post-event data points stored (default 44) - ** edit this **
...
handles.par.inputs = 32;                    %number of inputs to the clustering (default 10)
